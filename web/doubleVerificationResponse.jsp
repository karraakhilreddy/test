            ...
            <center>
                <div class="mainBackground">
                   ...
                   <%
                    ...
                    String encStatusData=(String)request.getParameter("encStatusData");
                    ...
                    char place=data[5].charAt(0);
                     ...
                     String insertTableSQL = "INSERT INTO `cdc`.`payments`(`cCode`,`merchantOrderNo`,`SBIePayReferenceID`,`status`,`amount`,`currency`,`payMode`,`otherDetails`,`reason`,`bankCode`,`bankReferenceNumber`,`transactionDate`,`country`,`cin`)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?);";
                                                         ps=con.prepareStatement(insertTableSQL);
                                                                ...
                                                                l.updateLog(cCode, "Made "+feeFor+" Payment", "Made Payment of Rs."+data[6],ipAddress);
                    ...
                    switch(place){
                        case '1':
                                        try {
                                                         ...
                                                         insertTableSQL = "UPDATE `cdc_college_details` SET `iAmount` ='"+data[6]+"', `iDate`='"+date+"',`iOrderNo`='"+data[5]+"' WHERE `cCode` =?;";
                                                         ps=con.prepareStatement(insertTableSQL);
                                                         ps.setString(1, cCode);
                                                          ps.executeUpdate();
                                                          
                                                                      l.updateLog(cCode, "Updated courses status to fee paid", "Made Payment of Rs."+data[6],ipAddress);
                    ...
                    break;
                        case '2':
                            ...
                            try{
                                                         ...
                                                         insertTableSQL = "UPDATE `cdc_college_details` SET `aAmount` ='"+data[6]+"', `aDate`='"+date+"',`aOrderNo`='"+data[5]+"' WHERE `cCode` =?;";
                                                         ps=con.prepareStatement(insertTableSQL);
                                                         ps.setString(1, cCode);
                                                          ps.executeUpdate();
