    ...
    <body>
        <% 
            ...
            switch(name){
                ...
                String typeOfCollege=request.getParameter("typeOfCollge");
               ...
               // Boolean valOwnBuilding =Boolean.parseBoolean( request.getParameter("valOwnBuilding"));
                ...
                String landRegNo= request.getParameter("landRegNo");
               ...
               // String pPANNo= request.getParameter("pPANNo");
                ...
                String uQuery="update cdc_college_details set cAddress = ?,typeOfCollege=?,sName=?,sAddress=?,sPostalAddress=?,sregNo=?,sYear=?,"+
                        ...
                        "lRegDate=?,landSurveyNumber=?,landDocNo=?,landRegNo=?,valRegSociety = ?,valSecMem=?,valSocietyMem=?,valSingleBit=?,valLandCert=?,"+
                        ...
                        "noPeriodicals=?,noTeachingStaff=?, noNonTeachingStaff=?, CFDAmount=?, staffRoomArea=? , noClassRooms=?,noLabRooms=? where sno = ?;";
